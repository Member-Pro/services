...
{
    public partial class RenameActivityRecords : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_achievement_activity", x => x.id);
                    table.ForeignKey(
                        name: "fk_achievement_activity_achievement_achievement_id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_achievement_activity_member_member_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_achievement_activity_achievement_id",
                table: "achievement_activity",
                column: "achievement_id");

            migrationBuilder.CreateIndex(
                name: "ix_achievement_activity_member_id",
                table: "achievement_activity",
                column: "member_id");
