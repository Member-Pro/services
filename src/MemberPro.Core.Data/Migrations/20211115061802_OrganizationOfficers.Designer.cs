...
namespace MemberPro.Core.Data.Migrations
{
    ...
    [Migration("20211115061802_OrganizationOfficers")]
    partial class OrganizationOfficers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Achievements.AchievementActivity", b =>
                {
                    ...
                    b.ToTable("achievement_activity", (string)null);
                });
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Achievements.AchievementComponent", b =>
                {
                    ...
                    b.ToTable("achievement_component", (string)null);
                });
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Achievements.MemberRequirementState", b =>
                {
                    ...
                    b.ToTable("member_requirement_state", (string)null);
                });
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Members.FavoriteAchievement", b =>
                {
                    ...
                    b.ToTable("favorite_achievement", (string)null);
                });
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Members.Member", b =>
                {
                    ...
                    b.HasIndex("CurrentPlanId")
                        .HasDatabaseName("ix_member_current_plan_id");
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Members.MemberAchievementProgress", b =>
                {
                    ...
                    b.ToTable("member_achievement_progress", (string)null);
                });
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Members.MemberCustomFieldValue", b =>
                {
                    ...
                    b.ToTable("member_custom_field_value", (string)null);
                });
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Members.MemberRenewal", b =>
                {
                    ...
                    b.ToTable("member_renewal", (string)null);
                });
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Members.MemberRole", b =>
                {
                    ...
                    b.ToTable("member_role", (string)null);
                });
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Organizations.Officer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("MemberId")
                        .HasDatabaseName("ix_officer_member_id");

                    b.HasIndex("PositionId")
                        .HasDatabaseName("ix_officer_position_id");

                    b.ToTable("officer", (string)null);
                });

            modelBuilder.Entity("MemberPro.Core.Entities.Organizations.OfficerPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_officer_position");

                    b.HasIndex("OrganizationId")
                        .HasDatabaseName("ix_officer_position_organization_id");

                    b.ToTable("officer_position", (string)null);
                });

            modelBuilder.Entity("MemberPro.Core.Entities.Organizations.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ParentId")
                        .HasDatabaseName("ix_organization_parent_id");
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Members.Member", b =>
                {
                    ...
                    b.HasOne("MemberPro.Core.Entities.Plans.MembershipPlan", "CurrentPlan")
                        .WithMany()
                        .HasForeignKey("CurrentPlanId")
                        .HasConstraintName("fk_member_membership_plan_current_plan_id");

                    b.HasOne("MemberPro.Core.Entities.Organizations.Organization", "Organization")
                        .WithMany()
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Organizations.Officer", b =>
                {
                    b.HasOne("MemberPro.Core.Entities.Members.Member", "Member")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_officer_member_member_id");

                    b.HasOne("MemberPro.Core.Entities.Organizations.OfficerPosition", "Position")
                        .WithMany()
                        .HasForeignKey("PositionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_officer_officer_position_position_id");
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Organizations.OfficerPosition", b =>
                {
                    b.HasOne("MemberPro.Core.Entities.Organizations.Organization", "Organization")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_officer_position_organization_organization_id");
            ...
            modelBuilder.Entity("MemberPro.Core.Entities.Organizations.Organization", b =>
                {
                    b.HasOne("MemberPro.Core.Entities.Organizations.Organization", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_organization_organization_parent_id");
